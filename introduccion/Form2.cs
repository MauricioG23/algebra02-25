...
namespace introduccion
{
    public partial class Form2 : Form
    {
        ...
        {
            int num1 = Convert.ToInt32(tb_numb1.Text);
            int num2 = Convert.ToInt32(tb_numb2.Text);
            int suma = num1 + num2;
        ...
        private void CalcMulti(object sender, EventArgs e)
        {
            ...
            lb_result.Text = multiplicacion.ToString();
        }
        private void CalcDivision(object sender, EventArgs e)
        {
            decimal num1 = Convert.ToInt32(tb_numb1.Text);
            decimal num2 = Convert.ToInt32(tb_numb2.Text);
            decimal Division = num1 / num2;
            lb_result.Text = Division.ToString();
        }
